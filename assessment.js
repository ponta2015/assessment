...
const tweetDidided = document.getElementById('tweet-area');
...
assessmentButton.onclick = function(){
    ...
    removeAllChildren(tweetDidided);
    ...
    tweetDidided.appendChild(anchor);
    const script = document.createElement('script');
    script.setAttribute('src','https://platform.twitter.com/widgets.js');
    tweetDidided.appendChild(script);
};
